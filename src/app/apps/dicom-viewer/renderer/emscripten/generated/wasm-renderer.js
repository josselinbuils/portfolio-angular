...
function integrateWasmJS() {
  ...
  var wasmTextFile = Module['wasmTextFile'] || 'wasm-renderer.wast';
  var wasmBinaryFile = Module['wasmBinaryFile'] || 'wasm-renderer.wasm';
  var asmjsCodeFile = Module['asmjsCodeFile'] || 'wasm-renderer.temp.asm.js';
...
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "wasm-renderer.js.mem" : null;
...
var real__fillTable = asm["_fillTable"]; asm["_fillTable"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__fillTable.apply(null, arguments);
};
...
var _fillTable = Module["_fillTable"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_fillTable"].apply(null, arguments) };
