...
export class CanvasRenderer implements Renderer {
  ...
  render(viewport: Viewport): void {
    ...
    const renderingProperties: any = {
      imageWidth,
      imageHeight,
      windowWidth: viewport.windowWidth,
      windowLevel: viewport.windowLevel,
    };

    if (JSON.stringify(renderingProperties) !== JSON.stringify(this.renderingProperties)) {
    ...
    this.context.drawImage(this.renderingContext.canvas, newX, newY, newWidth, newHeight);
  }
