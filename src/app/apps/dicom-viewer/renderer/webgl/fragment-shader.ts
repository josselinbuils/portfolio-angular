...
export function getTextureFormat(gl: WebGLRenderingContext, imageFormat: NormalizedImageFormat): GLenum {
  switch (imageFormat) {
...
export function getFragmentShaderSrc(imageFormat: NormalizedImageFormat): string {
  switch (imageFormat) {
    case NormalizedImageFormat.Int16:
