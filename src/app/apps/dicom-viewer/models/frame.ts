...
const MANDATORY_FIELDS = [
  'dicom', 'dimensionsMm', 'id', 'imageCenter', 'imageFormat', 'imageNormal', 'bitsAllocated', 'columns',
  'imageOrientation', 'imagePosition', 'patientName', 'photometricInterpretation', 'pixelData', 'pixelRepresentation',
  'pixelSpacing', 'rows', 'sliceLocation', 'sopInstanceUID', 'spacingBetweenSlices',
];
